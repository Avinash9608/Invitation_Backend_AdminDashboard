...
const About = () => {
  return (
    <>
      <div className=""></div>
      <div>
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-[var(--navbar-height)]">
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight ">
                Start your journey with{" "}
                <span className="text-red-500">SmileBox</span>
              </h1>
              <p className="mt-3 text-lg text-gray-800 dark:text-neutral-400">
                Hand-picked professionals and expertly crafted Templates,
                designed for any kind of Occassions.
              </p>

              <div className="mt-7 grid gap-3 w-full sm:inline-flex">
                <a
                  className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-500 text-white hover:bg-red-700 focus:outline-none focus:bg-red-700 disabled:opacity-50 disabled:pointer-events-none"
                  href="#"
                >
                  Get started
                  <svg
                ...
                <a
                  className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-600 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-600 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                  href="#"
                >
                  Contact sales team
                </a>
              ...
              <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                <div className="py-5">
                  <div className="flex gap-x-1">
                    <svg
                      className="size-4 text-yellow-800 dark:text-yellow-500"
                      width="51"
                      height="51"
                      viewBox="0 0 51 51"
                      fill="none"
                  ...
                  <p className="mt-3 text-sm text-gray-600 dark:text-black-500">
                    <span className="font-bold">4.6</span> /5 - from 12k reviews
                  </p>

                  <div className="mt-5">
                    <svg
                      className="h-auto w-16 text-gray-800 dark:text-gray-500"
                      width="80"
                      height="27"
                      viewBox="0 0 80 27"
                      fill="none"
            ...
            <div className="relative ms-4 w-full ">
              <img
                className="w-auto mt-20 rounded-md"
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            ...
            <div className="grow">
              <div>
                <h3 className="font-medium text-gray-800 dark:text-neutral-700">
                  David Forren
                </h3>
              ...
              <div className="mt-2 sm:mt-auto space-x-2.5">
                <a
                  className="inline-flex justify-center items-center text-gray-500 rounded-full hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-700 dark:focus:text-neutral-700"
                  href="#"
                >
                  <svg
